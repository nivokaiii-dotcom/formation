    ...
    <div class="container py-4">
        ...
        <?php if(isset($_GET['error'])): ?>
            <div class="alert alert-danger alert-dismissible fade show rounded-4 shadow-sm mb-4" role="alert">
                ...
                <?php 
                    if($_GET['error'] == 'limit_reached') echo "Action bloquée : Limite de 5 formateurs atteinte pour ce module.";
                    if($_GET['error'] == 'already_exists') echo "Action bloquée : Ce formateur est déjà assigné à ce module.";
                ?>
